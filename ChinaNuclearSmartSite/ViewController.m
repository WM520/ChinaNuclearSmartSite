...
- (void)request
{
    ...
    [[WMHttpNewManager sharedManager] GET:@"/appv2-web/api/version/upgrade/getNewVersion" parameters:@{@"orders":@"1",@"search_EQ_mobileType":@"IOS"} progress:^(NSProgress * _Nonnull downloadProgress) {
...
- (void)setUserInfoToApp:(NSDictionary *)userInfo
{
    ...
    userModel.phone = [[[userInfo objectForKey:@"phone"] class] isEqual:[NSNull class]] ? @"" : [userInfo objectForKey:@"phone"];
