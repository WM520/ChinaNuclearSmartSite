...
//    [self.view addSubview:self.warningLabel];
    ...
    CGFloat back_height = 35;
//
    self.backButton = [UIButton buttonWithType:UIButtonTypeSystem];
    self.backButton.frame = CGRectMake(20, kStatusBarHeight + 20, back_width, back_height);
    [self.backButton setImage:[[UIImage imageNamed:@"shop_cancel"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
...
//    [self.flashlight setImage:[UIImage imageNamed:@"openlight"] forState:UIControlStateNormal];
    [self.flashlight setImage:[[UIImage imageNamed:@"Flashlight_N"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
...
//        self.backHintLabel.center = CGPointMake(SCREEN_WIDTH / 4, CGRectGetMaxY(self.backButton.frame) + CGRectGetHeight(self.backHintLabel.frame) / 2);
        self.flashlight.center = CGPointMake(SCREEN_WIDTH / 2, SCREEN_HEIGHT - 100);
        self.flashlightHintLabel.center = CGPointMake(SCREEN_WIDTH / 2, CGRectGetMaxY(self.flashlight.frame) + CGRectGetHeight(self.flashlightHintLabel.frame) / 2);
    }
}
...
//        self.backHintLabel.center = CGPointMake(SCREEN_HEIGHT / 4, CGRectGetMaxY(self.backButton.frame) + CGRectGetHeight(self.backHintLabel.frame) / 2);
        self.flashlight.center = CGPointMake(SCREEN_HEIGHT / 2, SCREEN_WIDTH - 100);
        self.flashlightHintLabel.center = CGPointMake(SCREEN_HEIGHT / 2, CGRectGetMaxY(self.flashlight.frame) + CGRectGetHeight(self.flashlightHintLabel.frame) / 2);
